    ...
    computed: {
        ...
        formatContent() {
            return this.item.content.replace && this.item.content
                ...
                .replace(/<span class="kaibai">([^<]*?)<\/span>/g, '<details><summary>$1</summary><img data-action="preview" src="https://sexy.1433.top/$1" class="complate_span" title="神秘代码" alt="你来晚了"/></detail>')
